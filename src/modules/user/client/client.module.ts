...
import { CLIENT_GET_CACHE_INFO_WITHOUT_FLOW_SERVICE } from './interfaces/client.get-cache-info-without-flow-by-email.interface';
...
@Module({
  ...
  providers: [
    ...
    {
      provide: CLIENT_GET_CACHE_INFO_WITHOUT_FLOW_SERVICE,
